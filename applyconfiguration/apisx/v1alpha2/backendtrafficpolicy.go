...
type BackendTrafficPolicyApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *apisv1alpha2.PolicyStatusApplyConfiguration `json:"status,omitempty"`
}
...
func (b *BackendTrafficPolicyApplyConfiguration) WithStatus(value *apisv1alpha2.PolicyStatusApplyConfiguration) *BackendTrafficPolicyApplyConfiguration {
	b.Status = value
	return b
}

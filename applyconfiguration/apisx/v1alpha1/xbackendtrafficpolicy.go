...
// xBackendTrafficPolicy must be an unmodified XBackendTrafficPolicy API object that was retrieved from the Kubernetes API.
// ExtractXBackendTrafficPolicy provides a way to perform an extract/modify-in-place/apply workflow.

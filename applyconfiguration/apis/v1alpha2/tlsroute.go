...
// tLSRoute must be an unmodified TLSRoute API object that was retrieved from the Kubernetes API.
// ExtractTLSRoute provides a way to perform an extract/modify-in-place/apply workflow.

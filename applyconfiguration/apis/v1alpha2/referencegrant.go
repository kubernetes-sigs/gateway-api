...
// referenceGrant must be an unmodified ReferenceGrant API object that was retrieved from the Kubernetes API.
// ExtractReferenceGrant provides a way to perform an extract/modify-in-place/apply workflow.

...
func (b *TCPRouteRuleApplyConfiguration) WithName(value apisv1.SectionName) *TCPRouteRuleApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *TCPRouteRuleApplyConfiguration) WithBackendRefs(values ...*BackendRefApplyConfiguration) *TCPRouteRuleApplyConfiguration {
	for i := range values {
		if values[i] == nil {

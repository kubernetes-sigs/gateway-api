...
// gatewayClass must be an unmodified GatewayClass API object that was retrieved from the Kubernetes API.
// ExtractGatewayClass provides a way to perform an extract/modify-in-place/apply workflow.

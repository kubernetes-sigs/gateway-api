...
// hTTPRoute must be an unmodified HTTPRoute API object that was retrieved from the Kubernetes API.
// ExtractHTTPRoute provides a way to perform an extract/modify-in-place/apply workflow.

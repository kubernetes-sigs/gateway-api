...
func (b *UDPRouteRuleApplyConfiguration) WithName(value apisv1.SectionName) *UDPRouteRuleApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *UDPRouteRuleApplyConfiguration) WithBackendRefs(values ...*BackendRefApplyConfiguration) *UDPRouteRuleApplyConfiguration {
	for i := range values {
		if values[i] == nil {

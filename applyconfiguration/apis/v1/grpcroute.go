...
// gRPCRoute must be an unmodified GRPCRoute API object that was retrieved from the Kubernetes API.
// ExtractGRPCRoute provides a way to perform an extract/modify-in-place/apply workflow.

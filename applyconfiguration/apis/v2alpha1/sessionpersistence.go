...
type SessionPersistenceApplyConfiguration struct {
	...
	AbsoluteTimeout *apisv2alpha1.Duration               `json:"absoluteTimeout,omitempty"`
	IdleTimeout     *apisv2alpha1.Duration               `json:"idleTimeout,omitempty"`
	Type            *apisv2alpha1.SessionPersistenceType `json:"type,omitempty"`
...
func (b *SessionPersistenceApplyConfiguration) WithAbsoluteTimeout(value apisv2alpha1.Duration) *SessionPersistenceApplyConfiguration {
...
func (b *SessionPersistenceApplyConfiguration) WithIdleTimeout(value apisv2alpha1.Duration) *SessionPersistenceApplyConfiguration {
	b.IdleTimeout = &value
	return b
}
...
func (b *SessionPersistenceApplyConfiguration) WithType(value apisv2alpha1.SessionPersistenceType) *SessionPersistenceApplyConfiguration {
	b.Type = &value
	return b
}

...
func GatewayClass(name string) *GatewayClassApplyConfiguration {
	...
	b.WithAPIVersion("gateway.networking.k8s.io/v2alpha1")
	return b
}
...
// Experimental!
func ExtractGatewayClass(gatewayClass *apisv2alpha1.GatewayClass, fieldManager string) (*GatewayClassApplyConfiguration, error) {
...
// Experimental!
func ExtractGatewayClassStatus(gatewayClass *apisv2alpha1.GatewayClass, fieldManager string) (*GatewayClassApplyConfiguration, error) {
	return extractGatewayClass(gatewayClass, fieldManager, "status")
}

func extractGatewayClass(gatewayClass *apisv2alpha1.GatewayClass, fieldManager string, subresource string) (*GatewayClassApplyConfiguration, error) {
	b := &GatewayClassApplyConfiguration{}
	err := managedfields.ExtractInto(gatewayClass, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v2alpha1.GatewayClass"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}

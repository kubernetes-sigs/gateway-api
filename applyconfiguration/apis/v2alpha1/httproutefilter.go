...
type HTTPRouteFilterApplyConfiguration struct {
	Type                   *apisv2alpha1.HTTPRouteFilterType            `json:"type,omitempty"`
	...
	ExtensionRef           *ObjectReferenceApplyConfiguration           `json:"extensionRef,omitempty"`
}
...
func (b *HTTPRouteFilterApplyConfiguration) WithType(value apisv2alpha1.HTTPRouteFilterType) *HTTPRouteFilterApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *HTTPRouteFilterApplyConfiguration) WithExtensionRef(value *ObjectReferenceApplyConfiguration) *HTTPRouteFilterApplyConfiguration {

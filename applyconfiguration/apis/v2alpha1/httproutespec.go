...
type HTTPRouteSpecApplyConfiguration struct {
	...
	Hostnames                         []apisv2alpha1.Hostname           `json:"hostnames,omitempty"`
...
func (b *HTTPRouteSpecApplyConfiguration) WithHostnames(values ...apisv2alpha1.Hostname) *HTTPRouteSpecApplyConfiguration {
	for i := range values {

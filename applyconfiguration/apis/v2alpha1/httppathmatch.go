...
type HTTPPathMatchApplyConfiguration struct {
	Type  *apisv2alpha1.PathMatchType `json:"type,omitempty"`
...
func (b *HTTPPathMatchApplyConfiguration) WithType(value apisv2alpha1.PathMatchType) *HTTPPathMatchApplyConfiguration {
	b.Type = &value
	return b
}

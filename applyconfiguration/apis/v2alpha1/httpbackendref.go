...
func (b *HTTPBackendRefApplyConfiguration) WithGroup(value apisv2alpha1.Group) *HTTPBackendRefApplyConfiguration {
...
func (b *HTTPBackendRefApplyConfiguration) WithKind(value apisv2alpha1.Kind) *HTTPBackendRefApplyConfiguration {
...
func (b *HTTPBackendRefApplyConfiguration) WithName(value apisv2alpha1.ObjectName) *HTTPBackendRefApplyConfiguration {
...
func (b *HTTPBackendRefApplyConfiguration) WithNamespace(value apisv2alpha1.Namespace) *HTTPBackendRefApplyConfiguration {
...
func (b *HTTPBackendRefApplyConfiguration) WithPort(value apisv2alpha1.PortNumber) *HTTPBackendRefApplyConfiguration {

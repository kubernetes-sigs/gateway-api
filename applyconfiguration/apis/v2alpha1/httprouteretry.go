...
type HTTPRouteRetryApplyConfiguration struct {
	Codes    []apisv2alpha1.HTTPRouteRetryStatusCode `json:"codes,omitempty"`
	Attempts *int                                    `json:"attempts,omitempty"`
	Backoff  *apisv2alpha1.Duration                  `json:"backoff,omitempty"`
}
...
func (b *HTTPRouteRetryApplyConfiguration) WithCodes(values ...apisv2alpha1.HTTPRouteRetryStatusCode) *HTTPRouteRetryApplyConfiguration {
	for i := range values {
...
func (b *HTTPRouteRetryApplyConfiguration) WithBackoff(value apisv2alpha1.Duration) *HTTPRouteRetryApplyConfiguration {
	b.Backoff = &value
	return b
}

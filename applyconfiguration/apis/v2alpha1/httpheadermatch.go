...
type HTTPHeaderMatchApplyConfiguration struct {
	Type  *apisv2alpha1.HeaderMatchType `json:"type,omitempty"`
...
func (b *HTTPHeaderMatchApplyConfiguration) WithType(value apisv2alpha1.HeaderMatchType) *HTTPHeaderMatchApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *HTTPHeaderMatchApplyConfiguration) WithName(value apisv2alpha1.HTTPHeaderName) *HTTPHeaderMatchApplyConfiguration {
	b.Name = &value
	return b
}

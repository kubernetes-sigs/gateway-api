...
type GRPCMethodMatchApplyConfiguration struct {
	Type    *apisv2alpha1.GRPCMethodMatchType `json:"type,omitempty"`
...
func (b *GRPCMethodMatchApplyConfiguration) WithType(value apisv2alpha1.GRPCMethodMatchType) *GRPCMethodMatchApplyConfiguration {
	b.Type = &value
	return b
}

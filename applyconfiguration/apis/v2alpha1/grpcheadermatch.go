...
type GRPCHeaderMatchApplyConfiguration struct {
	Type  *apisv2alpha1.GRPCHeaderMatchType `json:"type,omitempty"`
	Name  *apisv2alpha1.GRPCHeaderName      `json:"name,omitempty"`
...
func (b *GRPCHeaderMatchApplyConfiguration) WithType(value apisv2alpha1.GRPCHeaderMatchType) *GRPCHeaderMatchApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *GRPCHeaderMatchApplyConfiguration) WithName(value apisv2alpha1.GRPCHeaderName) *GRPCHeaderMatchApplyConfiguration {
	b.Name = &value
	return b
}

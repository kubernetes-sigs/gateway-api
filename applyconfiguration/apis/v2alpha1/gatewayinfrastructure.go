...
type GatewayInfrastructureApplyConfiguration struct {
	Labels        map[apisv2alpha1.LabelKey]apisv2alpha1.LabelValue           `json:"labels,omitempty"`
	Annotations   map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue `json:"annotations,omitempty"`
...
func (b *GatewayInfrastructureApplyConfiguration) WithLabels(entries map[apisv2alpha1.LabelKey]apisv2alpha1.LabelValue) *GatewayInfrastructureApplyConfiguration {
	if b.Labels == nil && len(entries) > 0 {
		b.Labels = make(map[apisv2alpha1.LabelKey]apisv2alpha1.LabelValue, len(entries))
	}
...
func (b *GatewayInfrastructureApplyConfiguration) WithAnnotations(entries map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue) *GatewayInfrastructureApplyConfiguration {
	if b.Annotations == nil && len(entries) > 0 {
		b.Annotations = make(map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue, len(entries))
	}
	for k, v := range entries {
		b.Annotations[k] = v
	}

...
type RouteParentStatusApplyConfiguration struct {
	...
	ControllerName *apisv2alpha1.GatewayController    `json:"controllerName,omitempty"`
...
func (b *RouteParentStatusApplyConfiguration) WithControllerName(value apisv2alpha1.GatewayController) *RouteParentStatusApplyConfiguration {
...
func (b *RouteParentStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *RouteParentStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {

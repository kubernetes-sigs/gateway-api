...
type GRPCRouteFilterApplyConfiguration struct {
	Type                   *apisv2alpha1.GRPCRouteFilterType          `json:"type,omitempty"`
...
func (b *GRPCRouteFilterApplyConfiguration) WithType(value apisv2alpha1.GRPCRouteFilterType) *GRPCRouteFilterApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *GRPCRouteFilterApplyConfiguration) WithExtensionRef(value *ObjectReferenceApplyConfiguration) *GRPCRouteFilterApplyConfiguration {

...
type HTTPRouteMatchApplyConfiguration struct {
	...
	Method      *apisv2alpha1.HTTPMethod                `json:"method,omitempty"`
}
...
func (b *HTTPRouteMatchApplyConfiguration) WithMethod(value apisv2alpha1.HTTPMethod) *HTTPRouteMatchApplyConfiguration {
	b.Method = &value
	return b
}

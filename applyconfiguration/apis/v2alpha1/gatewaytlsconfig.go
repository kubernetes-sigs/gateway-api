...
type GatewayTLSConfigApplyConfiguration struct {
	Mode               *apisv2alpha1.TLSModeType                                   `json:"mode,omitempty"`
	...
	Options            map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue `json:"options,omitempty"`
}
...
func (b *GatewayTLSConfigApplyConfiguration) WithMode(value apisv2alpha1.TLSModeType) *GatewayTLSConfigApplyConfiguration {
	b.Mode = &value
	return b
}
...
func (b *GatewayTLSConfigApplyConfiguration) WithOptions(entries map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue) *GatewayTLSConfigApplyConfiguration {
	if b.Options == nil && len(entries) > 0 {
		b.Options = make(map[apisv2alpha1.AnnotationKey]apisv2alpha1.AnnotationValue, len(entries))
	}

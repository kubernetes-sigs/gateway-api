...
func (b *RouteNamespacesApplyConfiguration) WithFrom(value apisv2alpha1.FromNamespaces) *RouteNamespacesApplyConfiguration {
	b.From = &value
	return b
}
...
func (b *RouteNamespacesApplyConfiguration) WithSelector(value *v1.LabelSelectorApplyConfiguration) *RouteNamespacesApplyConfiguration {
	b.Selector = value
	return b
}

...
type HTTPPathModifierApplyConfiguration struct {
	Type               *apisv2alpha1.HTTPPathModifierType `json:"type,omitempty"`
...
func (b *HTTPPathModifierApplyConfiguration) WithType(value apisv2alpha1.HTTPPathModifierType) *HTTPPathModifierApplyConfiguration {
	b.Type = &value
	return b
}

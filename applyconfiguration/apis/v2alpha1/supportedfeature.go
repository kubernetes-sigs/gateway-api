...
type SupportedFeatureApplyConfiguration struct {
	Name *apisv2alpha1.FeatureName `json:"name,omitempty"`
}
...
func (b *SupportedFeatureApplyConfiguration) WithName(value apisv2alpha1.FeatureName) *SupportedFeatureApplyConfiguration {
	b.Name = &value
	return b
}

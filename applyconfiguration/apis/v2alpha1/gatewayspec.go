...
type GatewaySpecApplyConfiguration struct {
	GatewayClassName *apisv2alpha1.ObjectName                 `json:"gatewayClassName,omitempty"`
...
func (b *GatewaySpecApplyConfiguration) WithGatewayClassName(value apisv2alpha1.ObjectName) *GatewaySpecApplyConfiguration {

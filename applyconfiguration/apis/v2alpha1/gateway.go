...
// Experimental!
func ExtractGateway(gateway *apisv2alpha1.Gateway, fieldManager string) (*GatewayApplyConfiguration, error) {
...
// Experimental!
func ExtractGatewayStatus(gateway *apisv2alpha1.Gateway, fieldManager string) (*GatewayApplyConfiguration, error) {
	return extractGateway(gateway, fieldManager, "status")
}

func extractGateway(gateway *apisv2alpha1.Gateway, fieldManager string, subresource string) (*GatewayApplyConfiguration, error) {
	b := &GatewayApplyConfiguration{}
	err := managedfields.ExtractInto(gateway, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v2alpha1.Gateway"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}

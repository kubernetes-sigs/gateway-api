...
// Experimental!
func ExtractGRPCRoute(gRPCRoute *apisv2alpha1.GRPCRoute, fieldManager string) (*GRPCRouteApplyConfiguration, error) {
...
// Experimental!
func ExtractGRPCRouteStatus(gRPCRoute *apisv2alpha1.GRPCRoute, fieldManager string) (*GRPCRouteApplyConfiguration, error) {
	return extractGRPCRoute(gRPCRoute, fieldManager, "status")
}

func extractGRPCRoute(gRPCRoute *apisv2alpha1.GRPCRoute, fieldManager string, subresource string) (*GRPCRouteApplyConfiguration, error) {
	b := &GRPCRouteApplyConfiguration{}
	err := managedfields.ExtractInto(gRPCRoute, internal.Parser().Type("io.k8s.sigs.gateway-api.apis.v2alpha1.GRPCRoute"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}

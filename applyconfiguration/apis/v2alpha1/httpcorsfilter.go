...
type HTTPCORSFilterApplyConfiguration struct {
	AllowOrigins     []apisv2alpha1.AbsoluteURI            `json:"allowOrigins,omitempty"`
	AllowCredentials *bool                                 `json:"allowCredentials,omitempty"`
	AllowMethods     []apisv2alpha1.HTTPMethodWithWildcard `json:"allowMethods,omitempty"`
	AllowHeaders     []apisv2alpha1.HTTPHeaderName         `json:"allowHeaders,omitempty"`
	ExposeHeaders    []apisv2alpha1.HTTPHeaderName         `json:"exposeHeaders,omitempty"`
...
func (b *HTTPCORSFilterApplyConfiguration) WithAllowOrigins(values ...apisv2alpha1.AbsoluteURI) *HTTPCORSFilterApplyConfiguration {
	for i := range values {
...
func (b *HTTPCORSFilterApplyConfiguration) WithAllowMethods(values ...apisv2alpha1.HTTPMethodWithWildcard) *HTTPCORSFilterApplyConfiguration {
	for i := range values {
...
func (b *HTTPCORSFilterApplyConfiguration) WithAllowHeaders(values ...apisv2alpha1.HTTPHeaderName) *HTTPCORSFilterApplyConfiguration {
	for i := range values {
...
func (b *HTTPCORSFilterApplyConfiguration) WithExposeHeaders(values ...apisv2alpha1.HTTPHeaderName) *HTTPCORSFilterApplyConfiguration {
	for i := range values {

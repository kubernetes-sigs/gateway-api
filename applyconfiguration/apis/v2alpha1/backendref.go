...
func (b *BackendRefApplyConfiguration) WithGroup(value apisv2alpha1.Group) *BackendRefApplyConfiguration {
...
func (b *BackendRefApplyConfiguration) WithKind(value apisv2alpha1.Kind) *BackendRefApplyConfiguration {
...
func (b *BackendRefApplyConfiguration) WithName(value apisv2alpha1.ObjectName) *BackendRefApplyConfiguration {
...
func (b *BackendRefApplyConfiguration) WithNamespace(value apisv2alpha1.Namespace) *BackendRefApplyConfiguration {
...
func (b *BackendRefApplyConfiguration) WithPort(value apisv2alpha1.PortNumber) *BackendRefApplyConfiguration {

...
type HTTPRouteTimeoutsApplyConfiguration struct {
	Request        *apisv2alpha1.Duration `json:"request,omitempty"`
	BackendRequest *apisv2alpha1.Duration `json:"backendRequest,omitempty"`
}
...
func (b *HTTPRouteTimeoutsApplyConfiguration) WithRequest(value apisv2alpha1.Duration) *HTTPRouteTimeoutsApplyConfiguration {
	b.Request = &value
	return b
}
...
func (b *HTTPRouteTimeoutsApplyConfiguration) WithBackendRequest(value apisv2alpha1.Duration) *HTTPRouteTimeoutsApplyConfiguration {

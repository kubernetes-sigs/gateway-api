...
type GatewayStatusAddressApplyConfiguration struct {
	Type  *apisv2alpha1.AddressType `json:"type,omitempty"`
...
func (b *GatewayStatusAddressApplyConfiguration) WithType(value apisv2alpha1.AddressType) *GatewayStatusAddressApplyConfiguration {
	b.Type = &value
	return b
}

...
type HTTPRequestRedirectFilterApplyConfiguration struct {
	...
	Hostname   *apisv2alpha1.PreciseHostname       `json:"hostname,omitempty"`
...
func (b *HTTPRequestRedirectFilterApplyConfiguration) WithHostname(value apisv2alpha1.PreciseHostname) *HTTPRequestRedirectFilterApplyConfiguration {
	b.Hostname = &value
	return b
}
...
func (b *HTTPRequestRedirectFilterApplyConfiguration) WithPort(value apisv2alpha1.PortNumber) *HTTPRequestRedirectFilterApplyConfiguration {
	b.Port = &value
	return b
}

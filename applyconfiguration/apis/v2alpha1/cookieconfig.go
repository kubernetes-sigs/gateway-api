...
type CookieConfigApplyConfiguration struct {
	LifetimeType *apisv2alpha1.CookieLifetimeType `json:"lifetimeType,omitempty"`
}
...
func (b *CookieConfigApplyConfiguration) WithLifetimeType(value apisv2alpha1.CookieLifetimeType) *CookieConfigApplyConfiguration {

...
type ListenerApplyConfiguration struct {
	Name          *apisv2alpha1.SectionName           `json:"name,omitempty"`
	Hostname      *apisv2alpha1.Hostname              `json:"hostname,omitempty"`
	Port          *apisv2alpha1.PortNumber            `json:"port,omitempty"`
	Protocol      *apisv2alpha1.ProtocolType          `json:"protocol,omitempty"`
...
func (b *ListenerApplyConfiguration) WithName(value apisv2alpha1.SectionName) *ListenerApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *ListenerApplyConfiguration) WithHostname(value apisv2alpha1.Hostname) *ListenerApplyConfiguration {
	b.Hostname = &value
	return b
}
...
func (b *ListenerApplyConfiguration) WithPort(value apisv2alpha1.PortNumber) *ListenerApplyConfiguration {
	b.Port = &value
	return b
}
...
func (b *ListenerApplyConfiguration) WithProtocol(value apisv2alpha1.ProtocolType) *ListenerApplyConfiguration {
	b.Protocol = &value
	return b
}

...
type GRPCHeaderMatchApplyConfiguration struct {
	...
	Name  *v1alpha2.GRPCHeaderName `json:"name,omitempty"`
...
func (b *GRPCHeaderMatchApplyConfiguration) WithName(value v1alpha2.GRPCHeaderName) *GRPCHeaderMatchApplyConfiguration {
	b.Name = &value
	return b
}

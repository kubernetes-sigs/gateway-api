...
// Experimental!
func ExtractBackendTrafficPolicy(backendTrafficPolicy *apisv1alpha2.BackendTrafficPolicy, fieldManager string) (*BackendTrafficPolicyApplyConfiguration, error) {
...
// Experimental!
func ExtractBackendTrafficPolicyStatus(backendTrafficPolicy *apisv1alpha2.BackendTrafficPolicy, fieldManager string) (*BackendTrafficPolicyApplyConfiguration, error) {
	return extractBackendTrafficPolicy(backendTrafficPolicy, fieldManager, "status")
}

func extractBackendTrafficPolicy(backendTrafficPolicy *apisv1alpha2.BackendTrafficPolicy, fieldManager string, subresource string) (*BackendTrafficPolicyApplyConfiguration, error) {
	b := &BackendTrafficPolicyApplyConfiguration{}
...
func (b *BackendTrafficPolicyApplyConfiguration) WithStatus(value *PolicyStatusApplyConfiguration) *BackendTrafficPolicyApplyConfiguration {
	b.Status = value
	return b
}

    ...
    - name: targetRefs
      type:
        list:
          ...
          - kind
          - name
- name: io.k8s.sigs.gateway-api.apis.v1alpha2.BackendTrafficPolicy
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: io.k8s.sigs.gateway-api.apis.v1alpha2.BackendTrafficPolicySpec
      default: {}
    - name: status
      type:
        namedType: io.k8s.sigs.gateway-api.apis.v1alpha2.PolicyStatus
      default: {}
- name: io.k8s.sigs.gateway-api.apis.v1alpha2.BackendTrafficPolicySpec
  map:
    fields:
    - name: retry
      type:
        namedType: io.k8s.sigs.gateway-api.apis.v1alpha2.RetryConstraint
    - name: sessionPersistence
      type:
        namedType: io.k8s.sigs.gateway-api.apis.v1.SessionPersistence
    - name: targetRefs
...
- name: io.k8s.sigs.gateway-api.apis.v1alpha2.ReferenceGrant
  map:
    ...
    - name: spec
      ...
      default: {}
- name: io.k8s.sigs.gateway-api.apis.v1alpha2.RequestRate
  map:
    fields:
    - name: count
      type:
    ...
    - name: interval
      type:
        scalar: string
- name: io.k8s.sigs.gateway-api.apis.v1alpha2.RetryConstraint
  map:
    fields:
    - name: budgetInterval
      type:
    ...
    - name: minRetryRate
      type:
        namedType: io.k8s.sigs.gateway-api.apis.v1alpha2.RequestRate

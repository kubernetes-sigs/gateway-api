...
func (in *DirectPolicyTargetReference) DeepCopyInto(out *DirectPolicyTargetReference) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DirectPolicyTargetReference.
func (in *DirectPolicyTargetReference) DeepCopy() *DirectPolicyTargetReference {
	if in == nil {
		return nil
	}
	out := new(DirectPolicyTargetReference)
	in.DeepCopyInto(out)
	return out
}

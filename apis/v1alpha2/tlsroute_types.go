...
type TLSRouteRule struct {
	...
	// response being sent, the underlying implementation must actively reject request attempts to this backend,
	// by rejecting the connection or returning a 503 status code.
	// Request rejections must respect weight; if an invalid backend is requested to have 80% of requests,

...
type RouteStatus struct {
	...
	// route or gateway is modified. One exception is that Routes that fall out
	// of scope of a controller (e.g. because a Gateway they were attached to
	// changes GatewayClass, or for other, similar reasons) SHOULD NOT have their
	// status updated by that controller. This is because the controller can no
	// longer guarantee chain of ownership to the Route from the current state of
	// the cluster.
	//

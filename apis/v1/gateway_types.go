...
type Listener struct {
	...
	// * If the current Listener doesn’t match the SNI or Host, the Gateway
	//   SHOULD return a 421.
	//
...
const (
	...
	// combined with connection coalescing. When clients reuse connections using
	...
	// an existing connection that would not be used if the same request was

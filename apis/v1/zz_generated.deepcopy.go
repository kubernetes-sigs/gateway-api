...
func (in *BackendTLSPolicyValidation) DeepCopyInto(out *BackendTLSPolicyValidation) {
	*out = *in
	...
	if in.ClusterTrustBundleRef != nil {
		in, out := &in.ClusterTrustBundleRef, &out.ClusterTrustBundleRef
		*out = new(ClusterTrustBundleObjectRef)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterTrustBundleObjectRef) DeepCopyInto(out *ClusterTrustBundleObjectRef) {
	*out = *in
	if in.Group != nil {
		in, out := &in.Group, &out.Group
		*out = new(Group)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterTrustBundleObjectRef.
func (in *ClusterTrustBundleObjectRef) DeepCopy() *ClusterTrustBundleObjectRef {
	if in == nil {
		return nil
	}
	out := new(ClusterTrustBundleObjectRef)

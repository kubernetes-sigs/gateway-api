...
func (in *GatewaySpec) DeepCopyInto(out *GatewaySpec) {
	*out = *in
	...
	if in.TLSConfigs != nil {
		...
		*out = make(GatewayTLSConfigs, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in GatewayTLSConfigs) DeepCopyInto(out *GatewayTLSConfigs) {
	{
		in := &in
		*out = make(GatewayTLSConfigs, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayTLSConfigs.
func (in GatewayTLSConfigs) DeepCopy() GatewayTLSConfigs {
	if in == nil {
		return nil
	}
	out := new(GatewayTLSConfigs)
	in.DeepCopyInto(out)
	return *out
}

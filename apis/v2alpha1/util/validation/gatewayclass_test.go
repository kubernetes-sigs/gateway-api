...
import (
	...
	gatewayv2a1 "sigs.k8s.io/gateway-api/apis/v2alpha1"
	validationutil "sigs.k8s.io/gateway-api/apis/v2alpha1/util/validation"
)

func TestIsControllerNameValid(t *testing.T) {
	testCases := []struct {
		name           string
		controllerName gatewayv2a1.GatewayController
		isvalid        bool
	}{
		{

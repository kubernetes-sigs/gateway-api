...
// +kubebuilder:rbac:groups=networking.x.k8s.io,resources=virtualhosts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networking.x.k8s.io,resources=virtualhosts/status,verbs=get;update;patch
...
func (r *VirtualHostReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&networkingv1alpha1.VirtualHost{}).
		Complete(r)
}

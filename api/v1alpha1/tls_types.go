...
type TLSConfig struct {
	...
	//
	// +optional
	ALPNProtocols []ALPNProtocolType `json:"alpnProtocols,omitempty" protobuf:"bytes,1,rep,name=alpnProtocols"`
	...
	//
	// +required
	Certificates []CertificateObjectReference `json:"certificates" protobuf:"bytes,2,rep,name=certificates"`
	...
	//
	// +optional
	MinimumVersion *TLSVersionType `json:"minimumVersion,omitempty" protobuf:"bytes,3,rep,name=minimumVersion"`
...
// ALPNProtocolType identifies supported ALPN protocols.
//
// +k8s:deepcopy-gen=false
// +protobuf=false
type ALPNProtocolType string

const (
	// ALPNProtocolHTTP09 denotes the ALPN Protocol http/0.9.
	ALPNProtocolHTTP09 ALPNProtocolType = "http/0.9"
	// ALPNProtocolHTTP09 denotes the ALPN Protocol http/1.0.
	ALPNProtocolHTTP10 ALPNProtocolType = "http/1.0"
	// ALPNProtocolHTTP09 denotes the ALPN Protocol http/1.1.
	ALPNProtocolHTTP11 ALPNProtocolType = "http/1.1"
	// ALPNProtocolHTTP09 denotes the ALPN Protocol h2.
	ALPNProtocolH2 ALPNProtocolType = "h2"
	// ALPNProtocolHTTP09 denotes the ALPN Protocol h2c.
	ALPNProtocolH2C ALPNProtocolType = "h2c"
)

...
type GrpcEchoClient interface {
	...
	// Behaves identically to Echo, but lives at a different method.
...
func (c *grpcEchoClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *grpcEchoClient) EchoTwo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/EchoTwo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *grpcEchoClient) EchoThree(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/EchoThree", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GrpcEcho_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/Echo",
	}
...
func _GrpcEcho_EchoTwo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/EchoTwo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GrpcEcho_EchoThree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho/EchoThree",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var GrpcEcho_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ingress_controller_conformance.images.grpcechoserver.grpcecho.GrpcEcho",
	...
	Metadata: "conformance/proto/grpcechoserver/grpcecho.proto",
}

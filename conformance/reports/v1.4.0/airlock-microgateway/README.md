...
The Airlock Microgateway conformance report can be reproduced by following the steps in the [Gateway API conformance guide](https://github.com/airlock/microgateway/blob/5.0.0/gateway-api/conformance/conformance.md) on GitHub.

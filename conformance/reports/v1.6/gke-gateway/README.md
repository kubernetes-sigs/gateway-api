...
|-----------|----------------------|----|------|
|standard|1.36.2-gke.2154000|gke-l7-regional-external-managed|[v1.36.2 gke-l7-regional-external-managed report](./v1.6.0-gke-report.yaml)|

## Reproduce

GKE Gateway conformance report can be reproduced by the following steps.

1. create a GKE cluster with Gateway API enabled (the minimum cluster version that supports v1.6.0 CRD is `1.36.2-gke.2154000`)

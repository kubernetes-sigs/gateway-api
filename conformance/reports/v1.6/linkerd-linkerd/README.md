...
|--------------|-------------------------------------------|---------|--------------------------------------------------------|
| standard     | [version-2.20](https://github.com/linkerd/linkerd2/releases/tag/version-2.20/) | default | [version-2.20 report](./standard-2.20-default-report.yaml) |
...
2. Run `bash conformance/reports/v1.6/linkerd-linkerd/run-conformance.sh`.
...
3. The conformance report will be written to the
   `conformance/reports/v1.6/linkerd-linkerd/` directory.

...
|--------------|----------------------------------------------------------------------|---------|--------------------------------------------------|
| experimental | [v5.0.0](https://github.com/airlock/microgateway/releases/tag/5.0.0) | default | [link](./experimental-5.0.0-default-report.yaml) |
| standard     | [v5.1.0](https://github.com/airlock/microgateway/releases/tag/5.1.0) | default | [link](./standard-5.1.0-default-report.yaml) |

## Reproduce

### Airlock Microgateway >= 5.1.0
...
The Airlock Microgateway conformance report can be reproduced by following the steps in the [Gateway API conformance guide](https://github.com/airlock/microgateway/tree/5.0.0/gateway-api/conformance/conformance.md) on GitHub.
...
> Therefore, to run the conformance tests, a `ContentSecurityPolicy` with a `HeaderRewrites` (see [`conformance-report.yaml`](https://github.com/airlock/microgateway/blob/5.0.0/gateway-api/conformance/manifests/conformance-report.yaml)) is required to disable request header filtering for all `HTTPRoute` tests relying on the `MakeRequestAndExpectEventuallyConsistentResponse` assertion.

...
// GatewayV1alpha1Client is used to interact with features provided by the gateway.networking.k8s-x.io group.
type GatewayV1alpha1Client struct {
	restClient rest.Interface
}

func (c *GatewayV1alpha1Client) ListenerSets(namespace string) ListenerSetInterface {

...
import (
	...
	gatewayv1alpha1 "sigs.k8s.io/gateway-api/pkg/clientx/clientset/versioned/typed/apisx/v1alpha1"
	fakegatewayv1alpha1 "sigs.k8s.io/gateway-api/pkg/clientx/clientset/versioned/typed/apisx/v1alpha1/fake"
)

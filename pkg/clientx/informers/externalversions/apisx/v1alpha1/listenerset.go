...
import (
	...
	v1alpha1 "sigs.k8s.io/gateway-api/pkg/clientx/listers/apisx/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV1alpha1().ListenerSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV1alpha1().ListenerSets(namespace).Watch(context.TODO(), options)
			},
		},

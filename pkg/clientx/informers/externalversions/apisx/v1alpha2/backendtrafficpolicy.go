...
import (
	...
	versioned "sigs.k8s.io/gateway-api/pkg/clientx/clientset/versioned"
	internalinterfaces "sigs.k8s.io/gateway-api/pkg/clientx/informers/externalversions/internalinterfaces"
	v1alpha2 "sigs.k8s.io/gateway-api/pkg/clientx/listers/apisx/v1alpha2"
)
...
type BackendTrafficPolicyInformer interface {
	...
	Lister() v1alpha2.BackendTrafficPolicyLister
}
...
func (f *backendTrafficPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisxv1alpha2.BackendTrafficPolicy{}, f.defaultInformer)
}

func (f *backendTrafficPolicyInformer) Lister() v1alpha2.BackendTrafficPolicyLister {
	return v1alpha2.NewBackendTrafficPolicyLister(f.Informer().GetIndexer())
}

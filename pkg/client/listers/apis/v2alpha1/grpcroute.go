...
type GRPCRouteLister interface {
	...
	List(selector labels.Selector) (ret []*apisv2alpha1.GRPCRoute, err error)
...
type gRPCRouteLister struct {
	listers.ResourceIndexer[*apisv2alpha1.GRPCRoute]
}

// NewGRPCRouteLister returns a new GRPCRouteLister.
func NewGRPCRouteLister(indexer cache.Indexer) GRPCRouteLister {
	return &gRPCRouteLister{listers.New[*apisv2alpha1.GRPCRoute](indexer, apisv2alpha1.Resource("grpcroute"))}
}

// GRPCRoutes returns an object that can list and get GRPCRoutes.
func (s *gRPCRouteLister) GRPCRoutes(namespace string) GRPCRouteNamespaceLister {
	return gRPCRouteNamespaceLister{listers.NewNamespaced[*apisv2alpha1.GRPCRoute](s.ResourceIndexer, namespace)}
}
...
type GRPCRouteNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv2alpha1.GRPCRoute, error)

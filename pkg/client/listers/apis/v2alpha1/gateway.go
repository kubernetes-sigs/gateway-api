...
type GatewayLister interface {
	...
	List(selector labels.Selector) (ret []*apisv2alpha1.Gateway, err error)
...
type gatewayLister struct {
	listers.ResourceIndexer[*apisv2alpha1.Gateway]
}

// NewGatewayLister returns a new GatewayLister.
func NewGatewayLister(indexer cache.Indexer) GatewayLister {
	return &gatewayLister{listers.New[*apisv2alpha1.Gateway](indexer, apisv2alpha1.Resource("gateway"))}
}

// Gateways returns an object that can list and get Gateways.
func (s *gatewayLister) Gateways(namespace string) GatewayNamespaceLister {
	return gatewayNamespaceLister{listers.NewNamespaced[*apisv2alpha1.Gateway](s.ResourceIndexer, namespace)}
}
...
type GatewayNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv2alpha1.Gateway, error)

...
func NewGatewayClassLister(indexer cache.Indexer) GatewayClassLister {
	return &gatewayClassLister{listers.New[*apisv2alpha1.GatewayClass](indexer, apisv2alpha1.Resource("gatewayclass"))}
}

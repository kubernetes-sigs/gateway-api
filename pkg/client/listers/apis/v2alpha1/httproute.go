...
type HTTPRouteLister interface {
	...
	List(selector labels.Selector) (ret []*apisv2alpha1.HTTPRoute, err error)
...
type hTTPRouteLister struct {
	listers.ResourceIndexer[*apisv2alpha1.HTTPRoute]
}

// NewHTTPRouteLister returns a new HTTPRouteLister.
func NewHTTPRouteLister(indexer cache.Indexer) HTTPRouteLister {
	return &hTTPRouteLister{listers.New[*apisv2alpha1.HTTPRoute](indexer, apisv2alpha1.Resource("httproute"))}
}

// HTTPRoutes returns an object that can list and get HTTPRoutes.
func (s *hTTPRouteLister) HTTPRoutes(namespace string) HTTPRouteNamespaceLister {
	return hTTPRouteNamespaceLister{listers.NewNamespaced[*apisv2alpha1.HTTPRoute](s.ResourceIndexer, namespace)}
}
...
type HTTPRouteNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apisv2alpha1.HTTPRoute, error)

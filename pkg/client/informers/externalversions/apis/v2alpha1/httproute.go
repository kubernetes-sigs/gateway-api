...
type HTTPRouteInformer interface {
	...
	Lister() apisv2alpha1.HTTPRouteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV2alpha1().HTTPRoutes(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().HTTPRoutes(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().HTTPRoutes(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().HTTPRoutes(namespace).Watch(ctx, options)
			},
		},
		&gatewayapiapisv2alpha1.HTTPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hTTPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiapisv2alpha1.HTTPRoute{}, f.defaultInformer)
}

func (f *hTTPRouteInformer) Lister() apisv2alpha1.HTTPRouteLister {
	return apisv2alpha1.NewHTTPRouteLister(f.Informer().GetIndexer())
}

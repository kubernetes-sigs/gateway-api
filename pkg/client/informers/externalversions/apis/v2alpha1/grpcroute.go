...
import (
	...
	gatewayapiapisv2alpha1 "sigs.k8s.io/gateway-api/apis/v2alpha1"
	...
	apisv2alpha1 "sigs.k8s.io/gateway-api/pkg/client/listers/apis/v2alpha1"
)
...
type GRPCRouteInformer interface {
	...
	Lister() apisv2alpha1.GRPCRouteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV2alpha1().GRPCRoutes(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GRPCRoutes(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GRPCRoutes(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GRPCRoutes(namespace).Watch(ctx, options)
			},
		},
		&gatewayapiapisv2alpha1.GRPCRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gRPCRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiapisv2alpha1.GRPCRoute{}, f.defaultInformer)
}

func (f *gRPCRouteInformer) Lister() apisv2alpha1.GRPCRouteLister {
	return apisv2alpha1.NewGRPCRouteLister(f.Informer().GetIndexer())
}

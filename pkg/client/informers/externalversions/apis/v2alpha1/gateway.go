...
type GatewayInformer interface {
	...
	Lister() apisv2alpha1.GatewayLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV2alpha1().Gateways(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().Gateways(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().Gateways(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().Gateways(namespace).Watch(ctx, options)
			},
		},
		&gatewayapiapisv2alpha1.Gateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiapisv2alpha1.Gateway{}, f.defaultInformer)
}

func (f *gatewayInformer) Lister() apisv2alpha1.GatewayLister {
	return apisv2alpha1.NewGatewayLister(f.Informer().GetIndexer())
}

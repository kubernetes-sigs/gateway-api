...
type GatewayClassInformer interface {
	...
	Lister() apisv2alpha1.GatewayClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV2alpha1().GatewayClasses().List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GatewayClasses().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GatewayClasses().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2alpha1().GatewayClasses().Watch(ctx, options)
			},
		},
		&gatewayapiapisv2alpha1.GatewayClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewayapiapisv2alpha1.GatewayClass{}, f.defaultInformer)
}

func (f *gatewayClassInformer) Lister() apisv2alpha1.GatewayClassLister {
	return apisv2alpha1.NewGatewayClassLister(f.Informer().GetIndexer())
}

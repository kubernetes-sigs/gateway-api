...
type Interface interface {
	// CustomGRPCRoutes returns a CustomGRPCRouteInformer.
	CustomGRPCRoutes() CustomGRPCRouteInformer
...
// CustomGRPCRoutes returns a CustomGRPCRouteInformer.
func (v *version) CustomGRPCRoutes() CustomGRPCRouteInformer {
	return &customGRPCRouteInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

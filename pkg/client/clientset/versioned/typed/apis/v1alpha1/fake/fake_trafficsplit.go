...
var trafficsplitsResource = schema.GroupVersionResource{Group: "networking.x-k8s.io", Version: "v1alpha1", Resource: "trafficsplits"}

var trafficsplitsKind = schema.GroupVersionKind{Group: "networking.x-k8s.io", Version: "v1alpha1", Kind: "TrafficSplit"}
...
func (c *FakeTrafficSplits) UpdateStatus(ctx context.Context, trafficSplit *v1alpha1.TrafficSplit, opts v1.UpdateOptions) (*v1alpha1.TrafficSplit, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(trafficsplitsResource, "status", c.ns, trafficSplit), &v1alpha1.TrafficSplit{})

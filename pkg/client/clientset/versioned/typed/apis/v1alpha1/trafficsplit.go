...
func newTrafficSplits(c *NetworkingV1alpha1Client, namespace string) *trafficSplits {
...
func (c *trafficSplits) UpdateStatus(ctx context.Context, trafficSplit *v1alpha1.TrafficSplit, opts v1.UpdateOptions) (result *v1alpha1.TrafficSplit, err error) {
	result = &v1alpha1.TrafficSplit{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trafficsplits").

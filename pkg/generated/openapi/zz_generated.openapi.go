		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"hostname": {
						SchemaProps: spec.SchemaProps{
							Description: "Hostname is used for two purposes in the connection between Gateways and backends:\n\n1. Hostname MUST be used as the SNI to connect to the backend (RFC 6066). 2. Only if SubjectAltNames is not specified, Hostname MUST be used for\n   authentication and MUST match the certificate served by the matching\n   backend.\n\nSupport: Core",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"uri": {
						SchemaProps: spec.SchemaProps{
							Description: "URI contains Subject Alternative Name specified in URI format. Required when Type is set to URI, ignored otherwise.\n\nSupport: Core",
							Type:        []string{"string"},
							Format:      "",
						},
					},

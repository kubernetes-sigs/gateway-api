...
dot of a network host (e.g. <code>&quot;foo.example.com&quot;</code>) or &ldquo;wildcard&rdquo;, which is
a domain name prefixed with a single wildcard label (e.g.  <code>&quot;&ast;.example.com&quot;</code>).
The wildcard character <code>&quot;&ast;&quot;</code> must appear by itself as the first DNS
label and matches only a single label.
You cannot have a wildcard label by itself (e.g. Host == <code>&quot;&ast;&quot;</code>).</p>
...
<td>
<em>(Optional)</em>
<p>Mode defines the TLS behavior for the TLS session initiated by the client.</p>
<p>Support: Core</p>
</td>
</tr>
<tr>
...
define this concept. When unspecified, <code>&quot;&quot;</code>, or <code>&quot;&ast;&quot;</code>, all hostnames are
...
<p>Hostname can be &ldquo;precise&rdquo; which is a domain name without the terminating
dot of a network host (e.g. <code>&quot;foo.example.com&quot;</code>) or &ldquo;wildcard&rdquo;, which is a
domain name prefixed with a single wildcard label (e.g. <code>&quot;&ast;.example.com&quot;</code>).
The wildcard character <code>&quot;&ast;&quot;</code> must appear by itself as the first DNS label
...
the same port use &ldquo;<code>*</code>&rdquo; in the hostname field.</p>
</td>
...
<td>
<em>(Optional)</em>
<p>Allow indicates which Gateways will be allowed to use this route.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>From indicates where Routes will be selected for this Gateway.</p>
<p>Support: Core</p>
</td>
</tr>
<tr>

...
<p>
<p>HTTPRequestHeaderFilter defines configuration for the ModifyRequestHeader
filter.</p>
</p>
<table>
<thead>
...
<p>
<p>HTTPRequestMirrorFilter defines configuration for the MirrorRequest filter.</p>
</p>
<table>
<thead>
<tr>
...
&ldquo;Support: Core&rdquo; in this package, e.g. &ldquo;ModifyRequestHeader&rdquo;. All
...
&ldquo;Support: Extended&rdquo; in this package, e.g. &ldquo;MirrorRequest&rdquo;. Implementers
...
&ldquo;Custom&rdquo; for custom filters.</p></li>
</ul>
...
<td>
<em>(Optional)</em>
<p>ModifyRequestHeader defines a schema for a filter that modifies request
headers.</p>
<p>Support: Core</p>
</td>
</tr>
...
<td>
<em>(Optional)</em>
<p>MirrorRequest defines a schema for a filter that mirrors requests.</p>
<p>Support: Extended</p>
</td>
</tr>
<tr>
...
&ldquo;filter&rdquo; behavior.  The resource may be &ldquo;configmap&rdquo; or an
implementation-defined resource (for example, resource &ldquo;myroutefilters&rdquo;
in group &ldquo;networking.acme.io&rdquo;). ExtensionRef MUST NOT be used for core
and extended filters.</p>
<p>Support: Implementation-specific</p>
</td>
</tr>
</tbody>

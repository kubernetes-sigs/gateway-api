...
<p>
<p>UDPRoute is the Schema for the udproutes API.</p>
</p>
<table>
<thead>
<tr>
...
<h3 id="networking.x-k8s.io/v1alpha1.RouteCondition">RouteCondition
</h3>
<p>
(<em>Appears on:</em>
<a href="#networking.x-k8s.io/v1alpha1.RouteGatewayStatus">RouteGatewayStatus</a>)
...
<p>
<p>RouteCondition is a status condition for a given route.</p>
</p>
<table>
<thead>
<tr>
...
<code>type</code></br>
<em>
<a href="#networking.x-k8s.io/v1alpha1.RouteConditionType">
RouteConditionType
</a>
</em>
</td>
...
<td>
<em>(Optional)</em>
<p>Message is a human-understandable message describing the condition.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>Reason indicates why the condition is in this state.</p>
</td>
</tr>
<tr>
<td>
...
<p>
(<em>Appears on:</em>
<a href="#networking.x-k8s.io/v1alpha1.RouteCondition">RouteCondition</a>)
</p>
<p>
...
<code>conditions</code></br>
<em>
<a href="#networking.x-k8s.io/v1alpha1.RouteCondition">
[]RouteCondition
</a>
</em>
</td>
...
<td>
<em>(Optional)</em>
<p>Match defines which packets match this rule.</p>
</td>
</tr>
<tr>
<td>

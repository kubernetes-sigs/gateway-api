...
func (in *BackendParentStatus) DeepCopyInto(out *BackendParentStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackendParentStatus.
func (in *BackendParentStatus) DeepCopy() *BackendParentStatus {
	if in == nil {
		return nil
	}
	out := new(BackendParentStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BackendStatus) DeepCopyInto(out *BackendStatus) {
	*out = *in
	if in.Parents != nil {
		...
		*out = make([]BackendParentStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}

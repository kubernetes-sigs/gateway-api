...
type ListenerEntryStatusApplyConfiguration struct {
	...
	SupportedKinds []v1.RouteGroupKind                  `json:"supportedKinds,omitempty"`
...
func (b *ListenerEntryStatusApplyConfiguration) WithSupportedKinds(values ...v1.RouteGroupKind) *ListenerEntryStatusApplyConfiguration {
	for i := range values {

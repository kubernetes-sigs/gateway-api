...
type BackendTrafficPolicyApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *apisv1alpha2.PolicyStatus                  `json:"status,omitempty"`
}
...
// Experimental!
func ExtractBackendTrafficPolicy(backendTrafficPolicy *apisxv1alpha2.BackendTrafficPolicy, fieldManager string) (*BackendTrafficPolicyApplyConfiguration, error) {
...
// Experimental!
func ExtractBackendTrafficPolicyStatus(backendTrafficPolicy *apisxv1alpha2.BackendTrafficPolicy, fieldManager string) (*BackendTrafficPolicyApplyConfiguration, error) {
	return extractBackendTrafficPolicy(backendTrafficPolicy, fieldManager, "status")
}

func extractBackendTrafficPolicy(backendTrafficPolicy *apisxv1alpha2.BackendTrafficPolicy, fieldManager string, subresource string) (*BackendTrafficPolicyApplyConfiguration, error) {
	b := &BackendTrafficPolicyApplyConfiguration{}
...
func (b *BackendTrafficPolicyApplyConfiguration) WithStatus(value apisv1alpha2.PolicyStatus) *BackendTrafficPolicyApplyConfiguration {
	b.Status = &value
	return b
}

...
type BackendTrafficPolicySpecApplyConfiguration struct {
	TargetRefs         []v1alpha2.LocalPolicyTargetReference `json:"targetRefs,omitempty"`
	RetryConstraint    *RetryConstraintApplyConfiguration    `json:"retry,omitempty"`
	SessionPersistence *v1.SessionPersistence                `json:"sessionPersistence,omitempty"`
}
...
func (b *BackendTrafficPolicySpecApplyConfiguration) WithTargetRefs(values ...v1alpha2.LocalPolicyTargetReference) *BackendTrafficPolicySpecApplyConfiguration {
	for i := range values {
...
func (b *BackendTrafficPolicySpecApplyConfiguration) WithSessionPersistence(value v1.SessionPersistence) *BackendTrafficPolicySpecApplyConfiguration {

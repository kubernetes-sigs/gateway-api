...
You can read our [docs][ngrok-k8s-gwapi-docs] or [quickstart guide][ngrok-k8s-gwapi-qs] for more information. If you have any feature requests or bug reports, please [create an issue][ngrok-issue-new]. You can also reach out for help on [Slack][ngrok-slack]

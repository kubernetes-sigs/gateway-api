...
[Consul][consul], by [HashiCorp][hashicorp], is an open source control plane for multi-cloud networking. A single Consul deploymeent can span bare metal, VM and container environments.  

...
verb (like `Attached`). This one in particular is documented pretty closely in the
...
* The `Ready` condition will be moved to Extended conformance, and we'll reevaluate

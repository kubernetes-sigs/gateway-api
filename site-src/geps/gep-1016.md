...
// GRPCRoute is the Schema for the GRPCRoute resource.
...
type GRPCRouteSpec struct {
	...
	// the Host header to select a GRPCRoute to process the request.
	...
	// GRCRoute rules. If no hostname is specified, traffic is routed
	// based on the GRPCRouteRules.
	//
...
type GRPCRouteRule struct {
	...
	// * HTTPRoutes take precedence over GRPCRoutes
	// * The longest matching service.
	// * The longest matching method.

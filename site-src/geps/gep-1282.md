...
// BackendTargetReference identifies an API object to apply BackendCapabilities 
// to. 
// 
type BackendTargetReference struct {
	...
	Version ObjectName `json:"version"`
...
// affiliated BackendCapabilitiesService, and specified by the Service owner 
// (typically the application developer).  Examples of properties that 
...
type BackendCapabilitiesSpec struct {
	...
	// +optional
    Websocket *WebsocketType `json:”websocket,omitempty”`

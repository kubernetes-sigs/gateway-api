...
```go
  ...
  // to. The only kind of parent resource with "Core" support is Gateway. This
  // API may be extended in the future to support additional kinds of parent
  // resources such as Routes. It is invalid to reference the same parent

...
{{< readfile file="/examples/standard/basic-grpc.yaml" code="true" lang="yaml" >}}
...
GRPCRoute Rules include an optional `name` field. The applications for the name of a route rule are implementation-specific. It can be used to reference individual route rules by name from other resources, such as in the `sectionName` field of metaresources ([GEP-2648](/geps/gep-2648/#section-names)), in the status stanzas of resources related to the route object, to identify internal configuration objects generated by the implementation from GRPCRoute Rule, etc.
...
[grpcroute]: /reference/api-spec/main/spec/#grpcroute
[grpcrouterule]: /reference/api-spec/main/spec/#grpcrouterule
[hostname]: /reference/api-spec/main/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: /reference/api-spec/main/spec/#grpcroutematch
[filters]: /reference/api-spec/main/spec/#grpcroutefilter
[backendRef]: /reference/api-spec/main/spec/#grpcbackendref
[parentRef]: /reference/api-spec/main/spec/#parentreference
[name]: /reference/api-spec/main/spec/#sectionname

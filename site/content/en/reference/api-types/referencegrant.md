...
Please refer to [Security Considerations](/docs/concepts/security/#limiting-cross-namespace-references)
for more details.
...
Please see the [API
Specification](/reference/api-spec/main/spec/#referencegrant)
...
documentation](/docs/concepts/security/). Although conceptually similar to

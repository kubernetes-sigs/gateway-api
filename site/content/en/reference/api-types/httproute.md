...
{{< readfile file="/examples/standard/basic-http.yaml" code="true" lang="yaml" >}}
...
{{< details title="Standard Channel since v1.2.0" color="success" >}}
...
HTTPRoute Rules include an optional `name` field. The applications for the name of a route rule are implementation-specific. It can be used to reference individual route rules by name from other resources, such as in the `sectionName` field of metaresources ([GEP-2648](/geps/gep-2648/#section-names)), in the status stanzas of resources related to the route object, to identify internal configuration objects generated by the implementation from HTTPRoute Rule, etc.
...
{{< details title="Experimental Channel since v1.0.0" color="purple" >}}
...
[httprouterule]: /reference/api-spec/main/spec/#httprouterule
[hostname]: /reference/api-spec/main/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: /reference/api-spec/main/spec/#httproutematch
[filters]: /reference/api-spec/main/spec/#httproutefilter
[backendRef]: /reference/api-spec/main/spec/#httpbackendref
[parentRef]: /reference/api-spec/main/spec/#parentreference
[timeouts]: /reference/api-spec/main/spec/#httproutetimeouts
[appProtocol]: https://kubernetes.io/docs/concepts/services-networking/service/#application-protocol
[sectionName]: /reference/api-spec/main/spec/#sectionname

...
This table summarizes the various Route types included in Gateway API, with their **Routing Discriminators**.
...
Please refer to the [TLS details](/guides/user-guides/tls/) guide for a deep dive on TLS.

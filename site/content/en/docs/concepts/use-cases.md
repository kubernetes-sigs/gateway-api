...
[roles and personas]: /docs/concepts/roles-and-personas/
[Ana]: /docs/concepts/roles-and-personas/#key-roles-and-personas
[Chihiro]: /docs/concepts/roles-and-personas/#key-roles-and-personas
[Ian]: /docs/concepts/roles-and-personas/#key-roles-and-personas
...
[role and personas]: /docs/concepts/roles-and-personas/

## Basic [north/south] use case

{{< details title="Standard Channel since v0.8.0" >}}
...
TLS](/guides/user-guides/tls/#downstream-tls) at the Gateway, while simultaneously allowing
Ana and her colleagues control over the application's [routing
logic](/guides/user-guides/http-routing/) and rollout plans (e.g. [traffic splitting
rollouts](/guides/user-guides/traffic-splitting/)).

[north/south]: /docs/glossary/#northsouth-traffic
...
policies [such as TLS](/guides/user-guides/tls/#downstream-tls) can be enforced at the
Gateway. Meanwhile, Ana and Allison run their applications [in their own
Namespaces](/guides/user-guides/multiple-ns/), but attach their Routes to the same shared
Gateway, allowing them to independently control their [routing
logic](/guides/user-guides/http-routing/), [traffic splitting
rollout](/guides/user-guides/traffic-splitting/), etc., while not worrying about the things
...
[Route Attachment Process]: /docs/concepts/api-overview/#attaching-routes-to-gateways
...
[east/west]: /docs/glossary/#eastwest-traffic
[GAMMA]: ../mesh/
...
TLS](/guides/user-guides/tls/#downstream-tls) at the Gateway, while allowing Ana and
Allison to retain independent control of [routing
logic](/guides/user-guides/http-routing/), [traffic splitting
rollout](/guides/user-guides/traffic-splitting/), etc., both for [north/south] and for
[east/west] routing.




[gateway controller]: /docs/glossary/#gateway-controller
[Service routing]: /docs/glossary/#service-routing
[endpoint routing]: /docs/glossary/#endpoint-routing

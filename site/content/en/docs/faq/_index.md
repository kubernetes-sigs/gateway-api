...
The [community](/contributing/) page keeps track of how to get involved
with the project.
...
No. There are already many great [implementations](/docs/implementations/list/) to choose
...
[extension points](/docs/concepts/api-overview/#extension-points) for implementations
to use.
...
See the [Versioning](/docs/concepts/versioning/) documentation for more info.

#### Which Kubernetes versions are supported?
See our policy on [supported
versions](/docs/concepts/versioning/#supported-versions).
...
by [TLSRoutes](/docs/concepts/api-overview/#tlsroute). See the [TLS
Guide](/guides/user-guides/tls/) for more details about passthrough and other TLS
configurations.

...
[personas](/docs/concepts/roles-and-personas/) and corresponding resources that
...
[GRPCRoute](/reference/api-types/grpcroute/), etc) enable advanced routing capabilities
...
Each Gateway is associated with a [GatewayClass](/reference/api-types/gatewayclass/), which
...
[HTTPRoute](/reference/api-types/httproute/)) are then [associated with the Gateway
...
[north/south traffic]: /docs/glossary/#northsouth-traffic
[east/west traffic]: /docs/glossary/#eastwest-traffic
[gateway controller]: /docs/glossary/#gateway-controller
[gateway-attachment]: /docs/concepts/api-overview/#attaching-routes-to-gateways

## Gateway API for Service Mesh (the [GAMMA initiative](/docs/mesh/gamma/)) <a name="for-service-mesh"></a>
...
[GatewayClass](/reference/api-types/gatewayclass/) resources are not used; instead,
individual route resources (such as [HTTPRoute](/reference/api-types/httproute/)) are
...
To date, [GAMMA](/docs/mesh/) has been able to support mesh functionality with
...
- [API overview](/docs/concepts/api-overview/)
- [User guides](/guides/getting-started/)
- [Implementations](/docs/implementations/)
- [API reference spec](/reference/api-spec/)
...
Personas](/docs/concepts/roles-and-personas/).)
...
[use-cases]: /docs/concepts/use-cases/
...
Check out the [implementations reference](/docs/implementations/) to see the latest

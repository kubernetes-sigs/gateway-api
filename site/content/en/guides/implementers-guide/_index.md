...
Although the [Gateway API versioning policy](/docs/concepts/versioning/) largely
...
expand. There is a [TLS guide](/guides/user-guides/tls/) that covers this topic in more depth
...
Certificates (see [Roles and Personas](/docs/concepts/roles-and-personas/) for more on

---
title: "Getting started with Gateway API"
...
- [Deploying a simple Gateway](/guides/getting-started/simple-gateway/) (a good one to start out with)
- [HTTP routing](/guides/user-guides/http-routing/)
- [HTTP redirects and rewrites](/guides/user-guides/http-redirect-rewrite/)
- [HTTP traffic splitting](/guides/user-guides/traffic-splitting/)
- [Routing across Namespaces](/guides/user-guides/multiple-ns/)
- [Configuring TLS](/guides/user-guides/tls/)
- [TCP routing](/guides/user-guides/tcp/)
- [gRPC routing](/guides/user-guides/grpc-routing/)
- [ListenerSet](/guides/user-guides/listener-set/)

## Migrating from Ingress

If you are looking to migrate from Kubernetes Ingress, we have guides to help you get started.

- **[Migrating from Ingress](/guides/getting-started/migrating-from-ingress/)**: A general guide for migrating from any Ingress implementation to Gateway API. It covers the key differences and provides a manual migration example.
- **[A Welcome Guide for Ingress-NGINX Users](/guides/getting-started/migrating-from-ingress-nginx/)**: A guide specifically for users of Ingress-NGINX, the most popular Ingress implementation. It provides a set of resources and answers to frequently asked questions.

---

## Installing a Gateway controller

There are [multiple projects](/docs/implementations/list/) that support Gateway API. By
...
{{% alert color="danger" title="Upgrades from earlier Experimental Channel releases" %}}
...
documentation](/docs/concepts/versioning/).
...
[CRD Management Guide](../crd-management/).

...
This feature is part of extended support, and requires your implementation to support the feature `HTTPRouteCORS`. For more information on support levels, refer to our [conformance guide](/docs/concepts/conformance/).
...
{{< readfile file="/examples/standard/http-cors/httproute-specific-origin-no-creds.yaml" code="true" lang="yaml" >}}

Instead of specifying a list of specific origins, you can also specify a
single wildcard (`"*"`), which will allow any origin:

{{< readfile file="/examples/standard/http-cors/httproute-all-origins-no-creds.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/examples/standard/http-cors/httproute-origins-with-wildcards-no-creds.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/examples/standard/http-cors/httproute-credentials-true.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/examples/standard/http-cors/httproute-all-fields-set.yaml" code="true" lang="yaml" >}}
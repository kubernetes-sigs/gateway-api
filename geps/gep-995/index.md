...
Add a new optional `name` field to the route rule types ([GRPCRouteRule](/reference/api-spec/main/spec/#grpcrouterule), [HTTPRouteRule](/reference/api-spec/main/spec/#httprouterule), [TCPRouteRule](/reference/api-spec/main/spec/#tcprouterule), [TLSRouteRule](/reference/api-spec/main/spec/#tlsrouterule) and [UDPRouteRule](/reference/api-spec/main/spec/#udprouterule)) to support referencing individual rules by name.
...
This GEP proposes to add a new optional `name` field to the [GRPCRouteRule](/reference/api-spec/main/spec/#grpcrouterule), [HTTPRouteRule](/reference/api-spec/main/spec/#httprouterule), [TCPRouteRule](/reference/api-spec/main/spec/#tcprouterule), [TLSRouteRule](/reference/api-spec/main/spec/#tlsrouterule) and [UDPRouteRule](/reference/api-spec/main/spec/#udprouterule) types.

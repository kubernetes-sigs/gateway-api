...
10. The cluster operator should be allowed to override any gateway to backend TLS settings, to
satisfy organizational compliance policies.
...
### Istio Gateway supports this with a DestinationRule to encrypt the gateway->backend hop:
...
* Certificate verification by pod

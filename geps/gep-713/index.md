...
- when changing the spec of the object to hold the new piece of information is not possible (e.g., `ReferenceGrant`, from [GEP-709](https://gateway-api.sigs.k8s.io/geps/gep-709/), when affecting Secrets and Services);

...
It is not possible to have different `appProtocol` entries for the same port. A related [KEP-1435](https://github.com/kubernetes/enhancements/tree/master/keps/sig-network/1435-mixed-protocol-lb) mentions different `protocol` entries for the same port.

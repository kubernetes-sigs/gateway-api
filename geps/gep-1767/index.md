...
Then, the gateway will send the "preflight" response to the client directly.
...
* accessControlExposeHeaders:the values of header Access-Control-Expose-Headers sent in preflight response.

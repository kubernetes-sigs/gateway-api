...
- Should we add support for targeting a route matches section (ref [#2283](https://github.com/kubernetes-sigs/gateway-api/pull/2283) [#995](https://github.com/kubernetes-sigs/gateway-api/issues/995)?

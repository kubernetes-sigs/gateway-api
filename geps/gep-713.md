...
recomment transitioning to this structure for all Gateway API Policies.
...
the API structure defined above and add [corresponding label](https://gateway-api.sigs.k8s.io/geps/gep-713/#standard-label-on-crd-objects)
to the CRD.

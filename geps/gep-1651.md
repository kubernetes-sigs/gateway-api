...
reachability. Thus GatewayClass name is a viable option to control reachability. There may be a
...
This may not be as flexible for end-users compared to configuring `reachability` when creating
a Gateway.
